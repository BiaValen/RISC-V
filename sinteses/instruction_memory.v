...
initial begin
    ...
    mem[0] = 32'b00000000000100000000010100010011; // addi x10, x0, 1

    mem[1] = 32'b01111110101000000010110000100011; // sw x10, 2040(x0)

    mem[2] = 32'b11111111110111111111010011101111; // jal x9, -4
